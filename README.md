...
- Analytical chemistry figures: analytical-figures (publication-grade figures and the gated analysis behind them: FTIR/ATR and PXRD spectra, calibration with LOD/LOQ/recovery/ICH Q2 figures of merit, PLS/PCR/DD-SIMCA chemometrics, CIF validation plus calculated and lab-realistic PXRD and deterministic 3D views, cocrystal-vs-mixture identification; every figure ships as one self-contained, provenance-stamped script)
